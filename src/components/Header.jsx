...
export default function Header({ tab, onTabChange, due, onOpenSettings }) {
  return (
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="ml-1 inline-flex h-9 w-9 items-center justify-center rounded-full text-base hover:bg-white/10"
            title="Settings"
        ...
        {TABS.map((t) => (
          <button
            ...
            className={[
              ...
              tab === t.id ? 'bg-white/10 text-white' : 'text-white/65',
            ].join(' ')}
          >
            {t.label}
